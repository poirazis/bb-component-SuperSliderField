<script>
    ...
    {#if sliderType === "standard"}
        ...
        <div
            ...
            <div class="spectrum-Slider-controls">
                ...
                <SliderKnob bind:pos={_pos[0]} on:active={({ detail: v }) => active = v} />
                <div class="spectrum-Slider-track" style ="width: { (1-_pos[0]) * 100 }%; "></div>
            </div>
        </div>
    ...
    {:else if sliderType==="ticks"}
        ...
        class="spectrum-Slider" >
            ...
            <div class="spectrum-Slider-controls">
                <div class="spectrum-Slider-track" style="width: {_pos[0] * 100}%;"></div>
                <div class="spectrum-Slider-ticks" style="padding-left: 1px; pdding-right: 1px;">
